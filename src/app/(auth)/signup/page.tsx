'use client'
// [CYCL:60fb2df9-3c36-4d06-a33b-402e58d8e1ad] Sign-up page with email/password form using Supabase auth
  ...
  return (
    <>
      ...
      <p className="text-center text-sm text-[#5c5880] mt-4">
        ...
        <Link href="/login" className="text-[#a78bfa] hover:underline">Log in</Link>
      </p>
    </>
  )
}
